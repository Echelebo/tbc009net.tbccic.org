                            ...
                            <form action="{{ url('forget-password') }}" method="post" id="forget-password-form">
                                ...
                                <div class="auth-module-header">
                                    <div class="d-flex justify-content-start">
                                        <div class="logo-div">
                                            <a href="{{ url('/') }}"><img src="{{ image(settings('logo'), 'logo') }}"
                                                    alt="{{ __('Brand Logo') }}"></a>
                                        </div>
                                    </div>
                                    <p class="mb-0 text-center auth-title mt-20"
                                        style="color: #333333;>{{ __('Forgot Password?') }}</p>
                                    <p class="mb-0
                                        auth-text text-start mt-12 leading-24">
                                        {{ __('Please enter your email address associated with your account to receive a verification code.') }}
                                    </p>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-grid mb-3 mb-3p">
                                            <button class="btn btn-lg btn-primary" type="submit"
                                                ...
                                                <span class="px-1"
                                                    id="forget-password-submit-btn-text">{{ __('Send') }}</span>
...
@section('js')
    ...
    <script src="{{ asset('public/frontend/customs/js/forgot-password/forgot-password.min.js') }}" type="text/javascript">
    </script>
@endsection
