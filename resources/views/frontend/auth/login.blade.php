                    ...
                    <div class="auth-section signin-top d-flex align-items-center">
                        <div class="auth-module">
                            ...
                            <form action="{{ url('authenticate') }}" method="post" id="login-form">
                                @csrf
                                <input type="hidden" name="has_captcha"
                                    value="{{ isset($setting['has_captcha']) && ($setting['has_captcha'] == 'login' || $setting['has_captcha'] == 'login_and_registration') ? 'login' : 'Disabled' }}">

                                <input type="hidden" name="login_via"
                                    value="
                                @if (isset($setting['login_via']) && $setting['login_via'] == 'email_only') {{ 'email_only' }}
                                @elseif(isset($setting['login_via']) && $setting['login_via'] == 'phone_only')
                                    {{ 'phone_only' }}
                                @else
                                    {{ 'email_or_phone' }} @endif
                                ">
                                ...
                                <div class="auth-module-header">
                                    <p class="mb-0 text-center auth-title" style="color: #333333;">{{ __('Sign In') }}</p>
                                    <p class="mb-0
                                        text-center auth-text mt-12"
                                        style="color: #333333;"> {{ __('Don’t have an account?') }}<a
                                            href="{{ url('/register') }}">
                                            {{ __('Sign up here') }}</a></p>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        @if (isset($setting['login_via']) && $setting['login_via'] == 'email_only')
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="email" class="form-control input-form-control"
                                                    placeholder="{{ __('Email Address') }}" name="email_only"
                                                    id="email_only" required=""
                                        ...
                                        @elseif(isset($setting['login_via']) && $setting['login_via'] == 'phone_only')
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control input-form-control"
                                                    placeholder="{{ __('Phone') }}" name="phone_only" id="phone_only"
                                        ...
                                        @elseif(isset($setting['login_via']) && $setting['login_via'] == 'email_or_phone')
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control input-form-control"
                                                    placeholder="{{ __('Email') }}" name="email_or_phone"
                                                    id="email_or_phone" required=""
                                                    data-value-missing="{{ __('This field is required.') }}">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div id="show_hide_password" class="position-relative">
                                                <input type="password" class="form-control input-form-control"
                                        ...
                                        <!-- reCaptcha -->
                                        @if (isset($setting['has_captcha']) &&
                                                ($setting['has_captcha'] == 'login' || $setting['has_captcha'] == 'login_and_registration'))
                                            <div class="form-group mb-3">
                                                {!! app('captcha')->display() !!}
