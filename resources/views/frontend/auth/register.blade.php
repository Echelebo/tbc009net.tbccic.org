                ...
                <div class="col-md-6 col-12 col-xl-7">
                    ...
                    <div class="auth-section d-flex align-items-center create-account">
                        <div class="auth-module">
                            ...
                            <form action="{{ route('register.personal.info') }}" class="form-horizontal mt-4"
                                id="personal-info-form" method="POST">
                                @csrf
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div id="password-div" class="position-relative">
                                                <input type="password" class="form-control input-form-control"
                                                    ...
                                                    oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"
                                                    minlength="6"
                                                    data-min-length="{{ __(':x should contain at least :y characters.', ['x' => __('Password'), 'y' => '6']) }} "
                                        ...
                                        <div class="d-grid mb-3 mb-3p">
                                            <button class="btn btn-lg btn-primary" type="submit"
                                                ...
                                                <span class="px-1"
                                                    id="registrationSubmitBtnTxt">{{ __('Register') }}</span>
