                ...
                <div class="auth-section d-flex align-items-center create-account">
                      <div class="auth-module">
                       <div class="d-flex justify-content-start" style="padding: 5px; padding-top: 10px;"> 
                        ...
                        <form action="{{ route('register.personal.info') }}" class="form-horizontal mt-4" id="personal-info-form" method="POST">
                            @csrf
                            ...
                            <div class="auth-module-header">
                                <p class="mb-0 text-center auth-title" style="color: #333333;">{{ __('Create Account') }}</p>
                                <p class="mb-0 text-center auth-text mt-12" style="color: #333333;"> {{ __('Already have an account?') }} <a href="{{ url('login') }}">{{ __('Sign in here') }}</a></p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        maxlength="30" data-max-length="{{ __(':x length should be maximum :y charcters.', ['x' => __('First name'), 'y' => __('30')]) }}" placeholder="Name"> 
                                        @error('first_name')
                                            <span class="error"> {{ $message }} </span>
                                        @enderror
                                    </div>
